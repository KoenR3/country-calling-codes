CREATE TABLE IF NOT EXISTS `calling_code` (
  ...
  `phonecode` int(5) NOT NULL UNIQUE,
  PRIMARY KEY (`phonecode`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1;

INSERT INTO `calling_code` (`iso`, `name`, `nicename`, `iso3`, `numcode`, `phonecode`) VALUES
...
( 'DO', 'DOMINICAN REPUBLIC', 'Dominican Republic', 'DOM', 214, 1829),
( 'DO', 'DOMINICAN REPUBLIC', 'Dominican Republic', 'DOM', 214, 1849),
...
( 'PR', 'PUERTO RICO', 'Puerto Rico', 'PRI', 630, 1939),
...
INSERT INTO `calling_code` (`name`, `nicename`, `phonecode`) VALUES
('UNITED STATES-UNITED STATES MINOR OUTLYING ISLANDS-CANADA-SINT MAARTEN', 'Canada, Sint Maarten, United States,United States Minor Outlying Islands', 1),
('ITALY-HOLY SEE (VATICAN CITY STATE)', 'Italy-Holy See (Vatican City State)', 39),
('GUERNSEY-ISLE-JERSEY-UNITED KINGDOM', 'Guernsey-Isle-Jersey-United Kingdom', 44),
('NORWAY-SVALBARD AND JAN MAYEN', 'Norway-Svalbard and Jan Mayen', 47),
('AUSTRALIA-CHRISTMAS ISLAND', 'Australia-Christmas Island', 61),
('NEW ZEALAND-PITCAIRN', 'New Zealand-Pitcairn', 64),
('MOROCCO-WESTERN SAHARA', 'Morocco-Western Sahara', 212),
('CONGO-CONGO, THE DEMOCRATIC REPUBLIC OF THE', 'Congo-Congo, the Democratic Republic of the', 242),
('FRENCH SOUTHERN TERRITORIES-REUNION', 'French Southern Territories-Reunion',262),
('COMOROS-MAYOTTE', 'Comoros-Mayotte', 269),
('ALAND ISLANDS-FINLAND', 'Aland Islands-Finland', 358),
('SERBIA-KOSOVO', 'Serbia-Kosovo', 381),
('FALKLAND ISLANDS (MALVINAS)-SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS', 'Falkland Islands (Malvinas)-South Georgia and the South Sandwich Islands', 500),
('GUADELOUPE-SAINT BARTHELEMY-SAINT MARTIN', 'Guadeloupe-Saint Barthelemy-Saint Martin', 590),
('CURACAO-BONAIRE, SINT EUSTATIUS AND SABA-NETHERLANDS ANTILLES', 'Curacao-Bonaire, Sint Eustatius and Saba-Netherlands Antilles', 599),
('COCOS (KEELING) ISLANDS-NORFOLK ISLAND', 'Cocos (Keeling) Islands-Norfolk Island', 672);